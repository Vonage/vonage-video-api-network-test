...
// webpackConfig is an array [umdConfig, esmConfig]; use the UMD config's resolve settings.
          ...
          use: [
            {
              ...
              options: {
                transpileOnly: true,
                // Use a dedicated test tsconfig with rootDir './' so both
                // ./src and ./test files compile without TS6059
                configFile: resolve(dirName, 'tsconfig.test.json'),
              },
            },
          ],
        }],
