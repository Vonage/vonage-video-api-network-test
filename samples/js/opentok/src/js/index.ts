import NetworkTest, { ErrorNames, QualityTestResults } from 'opentok-network-test-js';
...
function testQuality() {
    ...
    otNetworkTest.testQuality(function updateCallback(stats: QualityTestResults) {
